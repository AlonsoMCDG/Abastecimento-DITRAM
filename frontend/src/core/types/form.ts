...
export interface FormField {
  name: string;            // Nome exato do campo no formulário/payload (ex.: 'veiculo_id')
  ...
  options?: Array<{ value: number | string; label: string }>; // Opções manuais/estáticas para selects
  ...
  visibleIf?: (values: any) => boolean; // Função condicional para mostrar ou ocultar este campo
